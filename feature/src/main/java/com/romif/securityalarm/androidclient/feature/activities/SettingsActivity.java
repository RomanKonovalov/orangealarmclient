...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar settingsToolbar = toolbarContainer.findViewById(R.id.settings_toolbar);
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            ListPreference unitList = (ListPreference) findPreference(SettingsConstants.UNIT_PREFERENCE);
            if (unitList != null) {
                unitList.setEntries(unitsNames);
    ...
    public static class AdvancedPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            findPreference(SettingsConstants.GEOZONE_NAME_PREFERENCE).setEnabled(false);
            findPreference(SettingsConstants.NOTIFICATION_NAME_PREFERENCE).setEnabled(false);
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            String[] emails = Stream.of(accounts).map(account -> account.name).filter(name -> gmailPattern.matcher(name).matches()).toArray(String[]::new);
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(SettingsConstants.RINGTONE_NOTIFICATION_PREFERENCE));
